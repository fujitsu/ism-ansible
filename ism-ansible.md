...
|operation_mode|〇|None|<ul><li>Online</li><li>Offline</li></ul>|Supported modes<br>Online: Online update<br>Offline: Offline update<br>[[Note3]](#note-2-3)|
...
|mode|〇|None|<ul><li>On</li><li>Off</li></ul>|Maintenance mode<br>“On”： Setting<br>“Off”： Release|
...
A case of specified value of the assign_range is only one case.
...
A case of specified value of the assign_range is two or more cases.
...
<a name="ism_firmware_list">ism_power_on
------------
...
<a name="ism_firmware_list">ism_refresh_node_info
----------------------------
...
Refreshing the node information of the ISM managed node.  
...
|OccurrenceDate|string|Always.|Time and date of occurence YYYY-MM-DDThh:mm:ss.xxxZ (date:year-month-day,time:hours-minute-second-millisecond. T and Z represent both separator characters and UTC in ISO8601 format.)|
