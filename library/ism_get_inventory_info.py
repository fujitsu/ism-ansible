...
short_description: Get the inventory information of ServerView Infrastructure Manager.
description:
    - "Provides an interface for get the inventory information of ServerView Infrastructure Manager."
version_added: "2.4" 
