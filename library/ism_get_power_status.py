...
short_description: Get the power status of ServerView Infrastructure Manager.
description:
    - "Provides an interface for get the power status of ServerView Infrastructure Manager."
version_added: "2.4" 
