...
short_description: Get the profile information of ServerView Infrastructure Manager.
description:
    - "Provides an interface for get the profile information of ServerView Infrastructure Manager."
version_added: "2.4" 
